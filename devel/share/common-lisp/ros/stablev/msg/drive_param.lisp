...
(cl:defmethod cl:initialize-instance :after ((m <drive_param>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'drive_param)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name stablev-msg:<drive_param> is deprecated: use stablev-msg:drive_param instead.")))

(cl:ensure-generic-function 'steer-val :lambda-list '(m))
(cl:defmethod steer-val ((m <drive_param>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader stablev-msg:steer-val is deprecated.  Use stablev-msg:steer instead.")
  (steer m))

(cl:ensure-generic-function 'throttle-val :lambda-list '(m))
(cl:defmethod throttle-val ((m <drive_param>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader stablev-msg:throttle-val is deprecated.  Use stablev-msg:throttle instead.")
  (throttle m))
